...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1
          style={{
            ...
            WebkitTextStroke: "1px rgba(212,132,90,0.85)",
            textAlign: "right",
            opacity: heroVisible ? 1 : 0,
            transform: heroVisible ? "none" : "translateY(40px)",
            transition:
        ...
        >
          <div
            style={{
              flex: 1,
              height: "1px",
              background: "rgba(242,237,229,0.09)",
            }}
          />
          <span
            style={{
      ...
      <div style={{ padding: `0 ${P}`, position: "relative", zIndex: 2 }}>
        <div
          style={{
            height: 1,
            background:
              "linear-gradient(90deg, transparent, rgba(212,132,90,0.14), transparent)",
          }}
        />
      </div>
              ...
              >
                ...
                >
                  {skills.map((s) => (
                    ...
                    >
                      <span style={{ color: COPPER, fontSize: "0.38rem" }}>
                        ●
                      </span>
                      {s}
                    </div>
      ...
      <section
        id="contact"
        style={{ position: "relative", padding: `8rem ${P} 10rem`, zIndex: 2 }}
      >
        <div
